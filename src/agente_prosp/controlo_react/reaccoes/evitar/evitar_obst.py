...
from agente_prosp.controlo_react.reaccoes.evitar.estimulo_obst import EstimuloObst
from agente_prosp.controlo_react.reaccoes.evitar.resposta_evitar import RespostaEvitar
