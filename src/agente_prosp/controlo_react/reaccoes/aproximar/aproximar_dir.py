...
from agente_prosp.controlo_react.reaccoes.aproximar.estimulo_alvo import EstimuloAlvo
from agente_prosp.controlo_react.reaccoes.resposta_mover import RespostaMover
